...
<body>
  ...
  <script src="{{ asset('theme_assets/vendors/chart.js/Chart.min.js') }}"></script>
  ...
  <script src="{{ asset('theme_assets/js/todolist.js') }}"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="{{ asset('theme_assets/js/dashboard.js') }}"></script>
